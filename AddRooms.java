            ...
            if (ae.getSource() == b1) {
                try {
                    ...
                    if (room.isEmpty() || price.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Room Number and Price cannot be empty!", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    if (!price.matches("\\d+")) {
                    ...
                    if (priceint < 1000 || priceint > 50000 || roomint >= 1000) {
                        JOptionPane.showMessageDialog(null, "Price must be a valid Invalide Room number or Price!", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }

                    String checkQuery = "SELECT * FROM room WHERE roomnumber = '" + room + "'";
